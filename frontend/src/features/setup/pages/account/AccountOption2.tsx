...
export const AccountOption2: React.FC = () => {
  return (
    <div className="p-6">
      <div className="bg-white rounded-2xl border-2 border-gray-200 p-8">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Account Option 2</h2>
            <p className="text-gray-600">Security and authentication settings</p>
          </div>
        </div>
        <div className="prose max-w-none">
          <p className="text-gray-700">
            This is <strong>Account Option 2</strong> subpage. Configure security settings,
